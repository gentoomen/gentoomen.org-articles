...
\author{John Anthony\\
  ...
  \date{Jan 29th, 2013}
%  Use the AMS article class (amsart) and you have the following extra commands:
%  \thanks{mother}           %% List any acknowledgements
%  \email{me@myplace.com}    %% The author’s email address.
%  \urladdr{www.myplace.com} %% Feel free to link your own website
\maketitle
